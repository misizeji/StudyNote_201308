...
#define VPLL_CON_REG                  __REG(ELFIN_CLOCK_POWER_BASE+VPLL_CON_OFFSET)
...
#define MP10DRV_REG                     __REG(ELFIN_GPIO_BASE + MP1_0DRV_SR_OFFSET)
#define MP11DRV_REG                     __REG(ELFIN_GPIO_BASE + MP1_1DRV_SR_OFFSET)
#define MP12DRV_REG                     __REG(ELFIN_GPIO_BASE + MP1_2DRV_SR_OFFSET)
#define MP13DRV_REG                     __REG(ELFIN_GPIO_BASE + MP1_3DRV_SR_OFFSET)
#define MP14DRV_REG                     __REG(ELFIN_GPIO_BASE + MP1_4DRV_SR_OFFSET)
#define MP15DRV_REG                     __REG(ELFIN_GPIO_BASE + MP1_5DRV_SR_OFFSET)
#define MP16DRV_REG                     __REG(ELFIN_GPIO_BASE + MP1_6DRV_SR_OFFSET)
#define MP17DRV_REG                     __REG(ELFIN_GPIO_BASE + MP1_7DRV_SR_OFFSET)
#define MP18DRV_REG                     __REG(ELFIN_GPIO_BASE + MP1_8DRV_SR_OFFSET)

#define MP20DRV_REG                     __REG(ELFIN_GPIO_BASE + MP2_0DRV_SR_OFFSET)
#define MP21DRV_REG                     __REG(ELFIN_GPIO_BASE + MP2_1DRV_SR_OFFSET)
#define MP22DRV_REG                     __REG(ELFIN_GPIO_BASE + MP2_2DRV_SR_OFFSET)
#define MP23DRV_REG                     __REG(ELFIN_GPIO_BASE + MP2_3DRV_SR_OFFSET)
#define MP24DRV_REG                     __REG(ELFIN_GPIO_BASE + MP2_4DRV_SR_OFFSET)
#define MP25DRV_REG                     __REG(ELFIN_GPIO_BASE + MP2_5DRV_SR_OFFSET)
#define MP26DRV_REG                     __REG(ELFIN_GPIO_BASE + MP2_6DRV_SR_OFFSET)
#define MP27DRV_REG                     __REG(ELFIN_GPIO_BASE + MP2_7DRV_SR_OFFSET)
#define MP28DRV_REG                     __REG(ELFIN_GPIO_BASE + MP2_8DRV_SR_OFFSET)

#define PHYCONTROL0_REG                     __REG(APB_DMC_0_BASE + DMC_PHYCONTROL0)
#define PHYCONTROL1_REG                     __REG(APB_DMC_0_BASE + DMC_PHYCONTROL1)
#define PHYSTATUS_REG                     __REG(APB_DMC_0_BASE + DMC_PHYSTATUS)

#define PHYCONTROL10_REG                     __REG(APB_DMC_1_BASE + DMC_PHYCONTROL0)
#define PHYCONTROL11_REG                     __REG(APB_DMC_1_BASE + DMC_PHYCONTROL1)
#define PHYSTATUS1_REG                     __REG(APB_DMC_1_BASE + DMC_PHYSTATUS)
